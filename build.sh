...
# Standard Linux gamepad mapping (no usbhid.quirks, no BTN_C/BTN_Z)
# D-pad is HAT hardware (ABS_HAT0X/Y) — use h0up notation
# Hotkey = PS button (BTN_MODE=10) for combo support
...
input_reset_btn = "0"
input_hold_fast_forward_btn = "12"
input_rewind_btn = "11"
