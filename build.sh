...
# Button IDs match es_input.cfg exactly (ES SDL raw evdev indices)
# PS4 kernel shifts standard evdev by +2 (inserts BTN_C=2, BTN_Z=5)
# D-pad is HAT hardware (ABS_HAT0X/Y) — use h0up notation
# Hotkey = PS button (BTN_MODE=12) for combo support
