...
echo ""
echo "  SSH/SFTP (recommended):"
echo "    Use any SFTP client (FileZilla, WinSCP)"
echo "    Server: PS4@<PS4_IP>  Path: /home/PS4/ROMS/"
echo ""
echo "  USB: Plug USB drive, copy files to:"
echo "    /home/PS4/ROMS/<system>/"
echo "    /home/PS4/BIOS/"
echo ""
echo "  Network shares (Samba/NFS/FTP):"
echo "    Enable via Settings in EmulationStation,"
echo "    or run from CLI: setup-samba.sh --toggle"
echo ""
